...
#region IMixedRealityCapabilityCheck Implementation
        ...
        public override void Enable()
        {
            ...
            if (leapControllerOrientation == LeapControllerOrientation.Headset)
            {
                ...
                GameObject leapProvider = GameObject.Find("LeapMotion");
                
                LeapMotionServiceProvider = leapProvider.GetComponent<LeapXRServiceProvider>(); //CameraCache.Main.gameObject.AddComponent<LeapXRServiceProvider>();\

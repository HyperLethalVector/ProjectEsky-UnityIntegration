...
namespace Microsoft.MixedReality.Toolkit.Esky.LeapMotion.Input
{
    ...
    /// </summary>
    [CreateAssetMenu(menuName = "Mixed Reality Toolkit/Profiles/Mixed Reality Leap Motion Profile", fileName = "EskyLeapMotionDeviceManagerProfile", order = 4)]
    [MixedRealityServiceProfile(typeof(EskyLeapMotionDeviceManager))]
    public class EskyLeapMotionDeviceManagerProfile : BaseMixedRealityProfile
    {
        [Space(10)]
        [SerializeField]

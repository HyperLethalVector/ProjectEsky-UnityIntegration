...
{
    [CustomEditor(typeof(EskyLeapMotionDeviceManagerProfile))]
    /// <summary>
    /// Custom inspector for the Leap Motion input data provider
    /// </summary>
    public class EskyLeapMotionDeviceManagerProfileInspector : BaseMixedRealityToolkitConfigurationProfileInspector
    {
        protected const string ProfileTitle = "Leap Motion Controller Settings";
        protected const string ProfileDescription = "";

        protected EskyLeapMotionDeviceManagerProfile instance;
        ...
        protected override void OnEnable()
        {
            ...
            instance = (EskyLeapMotionDeviceManagerProfile)target;

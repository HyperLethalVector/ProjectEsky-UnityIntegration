    ...
    public class TrackerAlignerUI : MonoBehaviour
    {
        ...
        void Update()
        {
            if(Input.GetKey(KeyCode.N)){
                MyTracker.RigCenter.localPosition += new Vector3(0 ,0, 1.0f*translationAdjustmentSpeed*Time.deltaTime );                
            }
            if(Input.GetKey(KeyCode.M)){
                MyTracker.RigCenter.localPosition -= new Vector3(0 ,0, 1.0f*translationAdjustmentSpeed*Time.deltaTime );                
            }            
            if(Input.GetKey(KeyCode.UpArrow)){
                MyTracker.RigCenter.localPosition += new Vector3(0 ,1.0f*translationAdjustmentSpeed*Time.deltaTime , 0);
            }
            if(Input.GetKey(KeyCode.LeftArrow)){
              MyTracker.RigCenter.localPosition += new Vector3(-1.0f*translationAdjustmentSpeed*Time.deltaTime , 0 , 0);
            }            
